...
public class ExporterExcelService {

    public void exporterDashboard(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    public void exporterClassement(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    public void exporterIndicateurs(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            List<ClubsLicenciesDTO> clubsLicenciesFederations =
                    dao.getClubsEtLicenciesParFederation(
                            region,
                            departement,
                            codeCommune
                    );
    ...
    private void remplirFeuilleClubsLicencies(
            Workbook workbook,
            String nomFeuille,
            String region,
            String departement,
        ...
        header.createCell(1).setCellValue("Département");
        header.createCell(2).setCellValue("Commune");
        header.createCell(3).setCellValue("Fédération sélectionnée");
        header.createCell(4).setCellValue("Fédération");
        header.createCell(5).setCellValue("Nombre de clubs");
        header.createCell(6).setCellValue("Nombre de licenciés");
        ...
        for (ClubsLicenciesDTO stat : stats) {
            ...
            row.createCell(0).setCellValue(region == null || region.isEmpty() ? "Toutes les régions" : region);
            row.createCell(1).setCellValue(departement == null || departement.isEmpty() ? "Tous les départements" : departement);
            row.createCell(2).setCellValue(codeCommune == null || codeCommune.isEmpty() ? "Toutes les communes" : codeCommune);
            row.createCell(3).setCellValue(federation == null || federation.isEmpty() ? "Toutes les fédérations" : federation);
            row.createCell(4).setCellValue(stat.getFederation());
            row.createCell(5).setCellValue(stat.getClubs());
            row.createCell(6).setCellValue(stat.getLicencies());
