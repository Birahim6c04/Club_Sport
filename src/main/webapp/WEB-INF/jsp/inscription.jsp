	...
	<div class="auth-split">
		...
		<div class="auth-left">
			<a href="${pageContext.request.contextPath}/accueil"
				...
				</div> <span>Club<strong>Sportif</strong></span>
			</a>
					...
					<div class="champ-modern">
						...
						<div class="input-wrapper">
							...
							<input type="text" name="login" value="${login}"
								placeholder="jdupont" required minlength="3">
						</div>
					</div>
					...
					<div class="champ-modern">
						...
						<div class="input-wrapper">
							...
							<input type="email" name="email" required
								...
								title="Entrez un email valide (exemple : jean@example.fr)"
					...
					<div class="champ-modern">
						...
						<div class="role-selector">
							<label class="role-card"> <input type="radio" name="role"
								...
								name="role" value="ELU" ${role == 'ELU' ? 'checked' : ''}>
								<div class="role-content">
									<div class="role-icon">🏛️</div>
									<strong>Élu</strong> <span>Local</span>
								</div>
							</label> <label class="role-card"> <input type="radio"
								name="role" value="ADMIN" ${role == 'ADMIN' ? 'checked' : ''}>
								<div class="role-content">
									<div class="role-icon">⚙️</div>
									<strong>Admin</strong> <span>Plateforme</span>
								</div>
							</label>
						</div>
					</div>
