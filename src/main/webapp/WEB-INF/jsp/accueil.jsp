...
<body>
    ...
    <nav class="navbar">
        <div class="nav-content">
            ...
            <div class="nav-links">
                ...
                <a href="#federations">Sports</a>
                <a href="#apropos">À propos</a>
            </div>
            <div class="nav-actions">
                <a href="connexion" class="btn-ghost">Connexion</a>
    ...
    <section class="hero">
        <div class="hero-content">
            <div class="hero-badge fade-in">
                <span class="dot"></span>
                Plateforme officielle - Données Ministère des Sports
            </div>
            <h1 class="hero-title fade-in">
                Trouvez le club sportif
                <span class="gradient-text">parfait pour vous</span>
            </h1>
            <p class="hero-subtitle fade-in">
                Plus de 110 000 clubs affiliés, 120 fédérations, partout en France.
                Découvrez en quelques clics les structures sportives près de chez vous.
            </p>
            <div class="hero-cta fade-in">
                ...
                <a href="#federations" class="btn-hero-ghost">
    ...
    <section class="section-howto reveal">
        ...
        <div class="steps-grid">
            <div class="step-card reveal">
                ...
                <div class="step-icon-wrap">
                    <svg class="step-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M21 21l-4.3-4.3M19 11a8 8 0 11-16 0 8 8 0 0116 0z"/>
                    </svg>
                </div>
                <h3>Choisissez un sport</h3>
                <p>Plus de 100 disciplines à explorer : du football au judo, en passant par les sports nautiques et la danse.</p>
            ...
            <div class="step-card reveal">
                ...
                <p>Recherchez par région, code postal, ou directement dans un rayon précis autour de votre commune.</p>
                <div class="step-arrow">→</div>
            </div>
            ...
            <div class="step-card reveal">
                ...
                <p>Visualisez les résultats sur une carte interactive et obtenez toutes les infos d'un simple clic.</p>
            </div>
        </div>
    </section>
    ...
    <section class="federations-section reveal" id="federations">
        <div class="section-header">
            ...
            <h2>Les sports les plus <span class="gradient-text">pratiqués</span></h2>
            <p>Découvrez les fédérations qui rassemblent le plus de licenciés en France</p>
        </div>
    ...
    <section class="avantages-section reveal">
        <div class="section-header">
            ...
            <h2>Une expérience <span class="gradient-text">premium</span></h2>
            <p>Conçue pour vous offrir le meilleur outil de recherche de clubs sportifs</p>
        </div>
        ...
        <div class="avantages-grille">
            <div class="avantage glass">
                ...
                <p>Informations officielles fournies directement par le Ministère des Sports.</p>
            </div>
            <div class="avantage glass">
                <div class="avantage-icone-wrap">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <p>Recherche par rayon avec calcul de distance en temps réel grâce à la géolocalisation.</p>
            </div>
            <div class="avantage glass">
                <div class="avantage-icone-wrap">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <h4>Ultra rapide</h4>
                <p>Recherche instantanée parmi 110 000 clubs grâce à une infrastructure optimisée.</p>
            </div>
            <div class="avantage glass">
                <div class="avantage-icone-wrap">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <p>Service entièrement gratuit, accessible sans création de compte ni données personnelles.</p>
            </div>
        </div>
    </section>
    ...
    <section class="apropos-section reveal" id="apropos">
        <div class="apropos-grid">
            <div class="apropos-text">
                ...
                <h2>Une plateforme <span class="gradient-text">étudiante</span> ambitieuse</h2>
                <p>Cette plateforme est née d'un projet étudiant à l'<strong>ESIGELEC</strong>, école d'ingénieurs en systèmes d'information.</p>
                <p>Notre objectif : démocratiser l'accès aux données sportives officielles et faciliter la mise en relation entre les pratiquants et les clubs affiliés.</p>

                <div class="apropos-tags">
                    <span class="tag-mini">data.gouv.fr</span>
                    <span class="tag-mini">OpenStreetMap</span>
                    <span class="tag-mini">Java EE</span>
                    <span class="tag-mini">MySQL</span>
            ...
            <div class="apropos-cards">
                <div class="apropos-card glass">
                    ...
                    <strong>Données 2019</strong>
                    <span>Statistiques officielles complètes du Ministère</span>
                </div>
                <div class="apropos-card glass">
                    <div class="card-icon">🗺️</div>
                    <strong>Cartographie HD</strong>
                    <span>Visualisation interactive haute précision</span>
                </div>
                <div class="apropos-card glass">
                    <div class="card-icon">🔒</div>
                    <strong>Vie privée</strong>
                    <span>Aucune collecte de données personnelles</span>
                </div>
                <div class="apropos-card glass">
                    <div class="card-icon">⚡</div>
                    <strong>Performance</strong>
                    <span>Architecture optimisée temps réel</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cta-section reveal">
        ...
        <div class="cta-content">
            <h2>Vous gérez un <span class="gradient-text-light">club sportif</span> ?</h2>
            <p>Rejoignez la plateforme et créez votre espace dédié pour communiquer avec vos licenciés et gagner en visibilité.</p>
            <div class="cta-buttons">
                ...
                <a href="#" class="btn-cta-ghost">En savoir plus</a>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="footer-colonnes">
            <div class="footer-colonne footer-brand">
                ...
                <p>La plateforme de référence pour découvrir les clubs sportifs partout en France.</p>
            </div>
        ...
        <div class="footer-bas">
            <p>© 2026 ClubSportif - Données : Ministère des Sports - Projet ESIGELEC</p>
        </div>
    </footer>
